...
$(document).ready(function() {
	...
	var setting = {
		...
		$("#attachs").on("click", ".delete", function() {	
			$(this).closest(".adds").remove();		//내 부모중에 input-group클래스 가지고있는거 찾음
		});
...
<style>
	...
	header{
		width:1920px;
		height:289px;
		background-image: url('../resources/img/write_m.jpg');
	...
	<header>
		...
		<form method="post" enctype="multipart/form-data">
			<div class="wrapper">
				...
				<div id="btns">
					<button class="write">등록</button> <a href="mlist?cg=0" class="cancel">취소</a>
