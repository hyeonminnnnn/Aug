...
<style>
	...
	header{
		width:1920px;
		height:289px;
		background-image: url('../resources/img/write_n.jpg');
	...
	<div class="wrapper">
		<form method="post" enctype="multipart/form-data">
			<div class="wrapper">
				<div id="top">			
					<div>
						<input name="title" type="text" placeholder="제목을 입력해주세요" style="width:1100px;">
					</div>
				</div>
				<div class="warring">
					<p>※ 카테고리를 선택해 주세요.</p>
				...
				<div id="btns">
					<button class="write">등록</button> <a href="notice" class="cancel">취소</a>
